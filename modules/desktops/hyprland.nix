{ config, lib, system, pkgs, hyprland, host, ... }:
  ...
  config = mkIf (config.hyprland.enable) {
    ...
    in
    {
      ...
      systemPackages = with pkgs; [
        ...
        #swww           # Animated Wallpaper
      	mpvpaper        # Set wallpaper through MPV
	];
    };
    ...
    let
      hyprlandConf = ''
        ...
        bind=SUPERSHIFT,Q,exec,${pkgs.hyprland}/bin/hyprctl dispatch exit
        ...
        exec-once=${pkgs.mpvpaper}/bin/mpvpaper -vs -o "no-audio loop" HDMI-A-1 /home/patrik/Pictures/Favourites/Sleeping-Fox-4K.mp4
    ...
    in
    {
      ...
      programs.swaylock.settings = {
        #image = "$HOME/Pictures/wallhaven-jx9kxp.jpg";
        color = "000000f0";
        font-size = "24";
